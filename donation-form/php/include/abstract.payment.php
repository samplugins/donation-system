...
abstract class AbstractPaymentGateway
{
    ...
    public abstract function StatusCodes();
    /**
    ...
    function comboStatus($value=''){
        ...
        foreach($data as $k=>$v){
            ...
            $str .= "<option value='".$v."'".$slcted.">".$v."</option>";
        }
        return $str;
    } 
    ...
    public function submitPayment()
    {
        ...
        echo "<div style='padding:40px; border: 1px solid #666666; background:#FF9; margin-left:70px; margin-top:100px; color:#000; width:80%; text-align:center; font-family:Verdana, Geneva, sans-serif; font-size:14px;'>\n";
        echo "<p><h3>Please wait, your payment is being processed and you will be redirected to the secure payment website.</h3></p>\n";
        ...
        echo "<p><br/>If you are not automatically redirected to ";
    ...
    public function set_ipn_data($post_data)
    {
         $this->ipnData = $post_data;
    }
}
